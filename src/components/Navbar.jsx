...
const navLinks = ["Home", "About", "Skills", "Experience", "Projects","Certifications","Workshops","Publications"];
    ...
    <header className="navbar-fixed pt-4">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 relative">
        ...
        <div className="hidden md:flex items-center space-x-4 relative z-10">
          {[
            { href: "https://www.linkedin.com/in/hrushikesh-jupalli/", icon: FaLinkedin, label: "LinkedIn" },
            { href: "https://github.com/Hrushi964", icon: FaGithub, label: "GitHub" },
            { href: "mailto:hrushikeshjupalli@gmail.com", icon: FaEnvelope, label: "Email" },
            { href: "https://wa.me/917989944121", icon: FaWhatsapp, label: "WhatsApp" },
          ].map((social) => (
            <motion.a
              key={social.label}
              href={social.href}
