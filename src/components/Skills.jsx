...
import { FaJava, FaPython, FaRobot, FaReact, FaNodeJs, FaGitAlt, FaFigma, FaHtml5, FaCss3Alt, FaFileExcel } from 'react-icons/fa'
import { SiTailwindcss, SiMongodb, SiJupyter, SiTableau, SiMicrosoftoffice, SiCanva, SiMysql, SiJavascript } from 'react-icons/si'
import { GiBrain } from 'react-icons/gi'

const technologies = [
  { name: 'C Programming', icon: <FaJava /> },
