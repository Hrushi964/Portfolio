...
const cards = [
  {
    ...
    subtitle: 'VIIT-Visakhapatnam',
    details: '8.62 CGPA | 2021 - 2025',
    certificate: 'https://drive.google.com/file/d/18MfiRGK4T53Kt/view?usp=drive_link'
  },
  {
    icon: <FaLaptopCode />,
    title: 'Intermediate - PCM',
    subtitle: 'Sri Chaitanya Junior College',
    details: '95.40% | 2019 - 2021',
    certificate: 'https://drive.google.com/file/d/18MfCDwxhTP3d6pM-Fy5ZxpiRGK4T53Kt/view?usp=drive_link'
  },
  {
    icon: <FaSchool />,
    title: 'Secondary School',
    subtitle: 'Dr.K.K.Rs Gowtham EM HS',
    details: '10.00 GPA | 2018 - 2019',
    certificate: 'https://drive.google.com/file/d/18FP0AYpL75AcgqFh8EvR125IwABsfYCo/view?usp=drive_link'
  },
]
  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        variants={itemVariants}
      >
        Hi! I am Hrushikesh Jupalli, passionate Software Developer with a strong interest in Data Science and AI-ML. I thrive on building intelligent, data-driven applications and continuously exploring emerging technologies to solve real-world problems.
      </motion.p>
          ...
          >
            ...
            {card.certificate && (
              <a
                ...
                className="relative inline-flex items-center justify-center px-7 py-3 rounded-lg font-semibold text-white bg-transparent border-2 border-cyan-400 overflow-hidden group transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-black mt-3"
              >
