...
const projects = [
  {
    title: 'ShopSense:AI-Driven Forecasting, Recommendation and Price Prediction of E-commerce Products',
    description: 'Created a system to compare prices across multiple E-Commerce platforms for example Amazon, Flipkart and Reliance.  Leveraged historical data and ML models to predict price trends, achieving an accuracy of 85% in price forecasting.',
    technologies: ['HTML','CSS','JavaScript','Python','Flask','Machine Learning','Deep Learning'],
    image: '/e-commerce.png',
    github: 'https://github.com/Hrushi964/Shopsense2025.git',
  },
  {
    title: 'Driver Drowsiness Detection',
    description: 'Built a real-time drowsiness detection system that reduced accident risk by 15% in test scenarios using Machine Learning. Integrated alarm with redirection to nearby hotels via Google Maps, improving driver safety response time by 25%.',
    technologies: ['Python','Machine Learning','Deep Learning'],
    image: '/drowsiness.jpg',
    github: 'https://github.com/Hrushi964/Driver-Drowsiness-Detection.git',
  },
  {
    title: 'Age and Gender Detection',
    description: 'Recruitment analysDeveloped a deep learning model for age and gender detection, achieving 90% accuracy in facial recognition. Enabled accurate demographic analysis and personalized feature deployment strategies using Machine Learning.',
    technologies: ['Python','Machine Learning'],
    image: '/age.jpeg',
    github: 'https://github.com/Hrushi964/Age-and-Gender-Recognition.git',
  },
  {
  ...
  {
    title: 'Rainfall Prediction using ML and DL',
    description: 'Recruitment analysDeveloped a deep learning model for age and gender detection, achieving 90% accuracy in facial recognition. Enabled accurate demographic analysis and personalized feature deployment strategies using Machine Learning.',
    technologies: ['Python','Machine Learning','Deep Learning'],
    image: '/rainfall.jpg',
  }
...
export default function Projects() {
  ...
  const technologies = {
    ...
    'Machine Learning': { icon: <SiTensorflow className="text-[#FF6F00]" />, name: 'Machine Learning' },
